...
Future<void> main(List<String> args) async {
  ...
  switch (method) {
    case 'platt':
      calib = _fitPlatt(train);
      break;
    case 'isotonic':
      calib = _fitIsotonic(train, bins: bins);
      break;
    default:
...
Calibrator _fitPlatt(List<RowRec> train) {
