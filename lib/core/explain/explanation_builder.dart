...
class ExplanationInput {
  ...
  final List<String> topFactors; // ex: ["momentum_5m", "rv_30m", "volume_spike"]
  final bool dataGaps;
...
class ExplanationBuilder {
  ...
  static ExplanationOutput build(ExplanationInput i) {
    ...
    final confPct = hasValidC ? (c * 100).clamp(0, 100).toStringAsFixed(0) : "—";
    ...
    final uncertainty = hasValidC ? "Uncertainty: ${_confBucket(c)}." : "Uncertainty elevated due to limited data.";
