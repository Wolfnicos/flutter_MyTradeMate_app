class S {
  ...
  static String get envHelpTestnet =>
  ...
  static String get provideBothKeys =>
  ...
  static String get a11ySendDiagnostics =>
      'Create and show path to diagnostic bundle';
...
class L10n {
  ...
  // General
  static String get signalWhy =>
      _isRomanian ? 'De ce acest semnal?' : 'Why this signal?';
  static String get paperBadge => 'PAPER / TESTNET';
  static String get modelCardOpen =>
      _isRomanian ? 'Card model →' : 'Model card →';
  static String get modelCardOpenLabel =>
      _isRomanian ? 'Deschide card model' : 'Open model card';
  static String get modelCardOpenHint => _isRomanian
      ? 'Deschide cardul modelului în browser'
      : 'Opens the model card in your browser';
  static String get modelCardOpenError => _isRomanian
      ? 'Nu s-a putut deschide cardul modelului'
      : 'Could not open model card';

  // Toggles
  static String get showUncertaintyNote =>
      _isRomanian ? 'Arată nota de incertitudine' : 'Show uncertainty note';
  static String get showDataGapsNote =>
      _isRomanian ? 'Arată nota despre goluri de date' : 'Show data gaps note';

  // AI Helper Screen
  static String get aiHelperTitle =>
      _isRomanian ? 'Asistent AI Trading' : 'AI Trading Assistant';
  static String get aiHelperWelcome => _isRomanian
      ? 'Asistent Inteligent Trading Crypto'
  ...
  static String get aiLiveData =>
      _isRomanian ? 'Date live de pe Binance' : 'Live data from Binance';
  static String get aiRealTimePredictions =>
      _isRomanian ? 'Predicții AI în timp real' : 'Real-time AI predictions';
  static String get aiMultiCurrency =>
      _isRomanian ? 'Suport USD/USDT/EUR' : 'USD/USDT/EUR support';
  static String get aiPremiumCrypto =>
      _isRomanian ? '5 Crypto Premium' : '5 Premium Crypto';
  static String get selectFiatCurrency =>
      _isRomanian ? 'Selectează Moneda Fiat' : 'Select Fiat Currency';
  static String get premiumCryptoLive => _isRomanian
      ? '5 Crypto Premium (Date LIVE)'
      : '5 Premium Crypto (LIVE Data)';
  static String get detailedAnalysis =>
      _isRomanian ? 'Analiză Detaliată' : 'Detailed Analysis';
  static String get aiPredictionLive =>
      _isRomanian ? 'Predicție AI (LIVE)' : 'AI Prediction (LIVE)';
  static String get marketDataLive =>
      _isRomanian ? 'Date Piață (LIVE)' : 'Market Data (LIVE)';
  ...
  static String get probabilityUp =>
      _isRomanian ? 'Probabilitate Creștere' : 'Probability Up';
  static String get estimatedReturn =>
      _isRomanian ? 'Return Estimat' : 'Estimated Return';
  ...
  static String get howItWorks =>
      _isRomanian ? 'Cum funcționează' : 'How it works';
  ...
  static String get aiPredictionsTitle =>
      _isRomanian ? 'Predicții AI' : 'AI Predictions';
  ...
  static String get quoteCurrencyTitle =>
      _isRomanian ? 'Quote Currency' : 'Quote Currency';
  ...
  static String get disclaimerAITitle =>
      _isRomanian ? 'Disclaimer' : 'Disclaimer';
